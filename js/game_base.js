if (void 0 == APP_BASE_URL) var APP_BASE_URL = "http://www.6m5m.com/";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "http://www.6m5m.com/";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "http://www.6m5m.com/";
var BASE_RES_DIR = "../",
	RES_DIR = "",
	APP_DEPLOYMENT = "WEB",
	USE_NATIVE_SOUND = !1,
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://www.6m5m.com/");
...
var mebtnopenurl = "http://mp.weixin.qq.com/s?__biz=MzI4MjA2MjE0MQ==&mid=xxxxxxxx&idx=1&sn=xxxxxxxxxxxxxxxxxxxxxxxx#rd";

window.shareData = {
    "imgUrl": "http://www.6m5m.com/icon/qbllk.png",
    "timeLineLink": "http://www.6m5m.com/games/qbllk/",
    "tTitle": "奇葩连连看-6m5m",
